...
12. Stop before merge, deployment, destructive migration, publication, or any consequential action requiring human approval under repository instructions.
...
6. tracker updates;
7. recommended next experiment(s), if justified by evidence.
